...
import 'schedule.dart' as _i4;
import 'package:instrument_scheduler_server/src/generated/schedule.dart' as _i5;
export 'example.dart';
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.Schedule) {
      return _i4.Schedule.fromJson(data) as T;
    }
    if (t == _i1.getType<_i3.Example?>()) {
      return (data != null ? _i3.Example.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i4.Schedule?>()) {
      return (data != null ? _i4.Schedule.fromJson(data) : null) as T;
    }
  ...
  @override
  String getModuleName() => 'instrument_scheduler';
}
